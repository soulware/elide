...
# each fly command before running it — the same commands docs/quickstart.md
# documents as the manual path.
#
...
created="$(run fly apps create --generate-name --json ${org:+-o "$org"})"
