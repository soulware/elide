...
auth service in [`design-auth-service.md`](design-auth-service.md)
landing first.
...
- [`design-auth-model.md`](design-auth-model.md) — operator
...
- [`design-peer-segment-fetch.md`](design-peer-segment-fetch.md) —
...
- **Coord is the operator's agent.** `design-auth-service.md` places
...
introduced — this preserves the framing in `design-peer-segment-fetch.md`
...
- **Home-host resolution.** Which artefact authoritatively names a
  ...
  `design-portable-live-volume.md` and the handoff protocol.
