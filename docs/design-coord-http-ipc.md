...
[`design-auth-service.md`](design-auth-service.md) forces the protocol
...
- **Remote coord IPC** (coord ↔ coord across hosts). Uses the
  ...
  [`design-remote-coord-ipc.md`](design-remote-coord-ipc.md).
...
canonical 401 challenge ([`design-auth-service.md`](design-auth-service.md)
