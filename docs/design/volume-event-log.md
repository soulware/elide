...
(see [`portable-live-volume.md`](portable-live-volume.md)).
...
- **`signature`** is over the canonicalised TOML (sorted keys, fixed
  ...
  `docs/design/portable-live-volume.md`). Verification is by lookup at
...
Same as `docs/design/portable-live-volume.md`:
