...
[`gc-overlap-correctness.md`](gc-overlap-correctness.md) established correctness by *skipping* any segment containing a partial-LBA-death entry.
...
Extend the tests in [`gc-overlap-correctness.md`](gc-overlap-correctness.md):
