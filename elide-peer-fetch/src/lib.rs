...
//! `docs/plans/peer-segment-fetch-v1-plan.md` for the design and plan.
//!
//! This crate contains:
//!
...
pub use client::{
    BodyFetchClient, BuildError, ClaimerTokenProvider, PeerFetchClient, PeerFetchClientBuilder,
    TokenSigner,
};
